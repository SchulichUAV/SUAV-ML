...
# def inference_worker(image_queues: Queue, detection_queue: Queue, client: InferenceHTTPClient, batch_size=12):
#     """
#     Worker thread to process images in batches and run inference.
#     """
    
#     while True:
#         image_queue = scan_directory_for_images(image_queues)
#         batch = []
...
#         print("imagesqueue in worker", image_queue)
...
global_counter = 0
scanned_images = set()  # To track processed images
